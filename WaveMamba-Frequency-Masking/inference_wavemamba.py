...
def main():
    ...
    parser.add_argument('-i', '--input', type=str,
                        default='/media/on23019/server1/video_dataset/debanding_dataset/deepDeband/split/test/banded',
                        help='Input image or folder')

    parser.add_argument('-g', '--gt', type=str,
                        default='/media/on23019/server1/video_dataset/debanding_dataset/deepDeband/split/test/pristine',
                        help='groundtruth image')
    parser.add_argument('-w', '--weight', type=str,
                        default='./ckpt/net_g_latest_WaveMamba.pth',
                        help='path for model weights')

    parser.add_argument('-o', '--output', type=str, default='results/deepDeband/WaveMamba', help='Output folder')
